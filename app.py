...
# -----------------------------------------------------------------------------
    ...
    """)
    st.latex(r"B = \{4\}")
    st.image("imagens/imagem 6.png", width=700, caption="Fonte: Elaborado pelo autor.")
    st.markdown("""
...
# -----------------------------------------------------------------------------
    ...
    st.image("imagens/imagem 4.png", width=900, caption= "Fonte: elaboração dos autores.")
